const messages = {
  ...
  orcid:
    "El ORCID debe contener 19 caracteres, incluyendo 16 números separados por 3 guiones en el siguiente formato: 1234-1234-1234-1234",
  id: "Este campo sólo puede contener letras mayúsculas, letras y guiones",
  colectorCode:
    "Este campo sólo acepta letras del alfabeto, espacios y puntos.",
  ...
  decimal:
    "Este campo sólo acepta cantidades decimales, del 0 hasta el 99.999, con un máximo de 3 digitos después del punto decimal",
